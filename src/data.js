...
const pokemon = [
    ...
    {
        name: "Hoopa Unbound",
        nameJa: "フーパ(ときはなたれしすがた)",
        atk: 311,
        def: 191,
        sta: 173
    }
];
export const POKEMON = Object.freeze(pokemon.map((entry)=>Object.freeze({
        ...entry
